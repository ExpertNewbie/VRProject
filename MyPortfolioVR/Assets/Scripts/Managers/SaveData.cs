...
public struct SaveData
{
    public SaveData(bool creater)
    {
        ...
        UpgradeSpeedBootserState = UpgradeSpeedBootser.Upgrade_0;
    ...
    public SaveData(SaveData data)
    {
        ...
        UpgradeSpeedBootserState = data.UpgradeSpeedBootserState;
        /////////////////////////////////////////////////////////////// Contruct Custom END
    }
    ...
    public UpgradeSpeedBootser UpgradeSpeedBootserState { get; set; }
    ...
    public enum UpgradeSpeedBootser
    {
        Upgrade_0,
        Upgrade_1,
        Upgrade_2,
